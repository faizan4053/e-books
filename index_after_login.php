<?php 
	...
	try{
		...
		$conn->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
			...
			$st=$conn->prepare("select * from login where login_id=:log");

			$st->bindParam(":log",$mail);

			$st->execute();
			$ft=$st->fetch();
			$_SESSION['user']=$ft['fname'];
            //echo $_SESSION["email"];
            //echo $ft['fname'];
            extract($_POST);
            if(isset($find)){
            ...
            $st1=$conn->prepare("select * from cart where login_id=:log");
            $st1->bindParam(":log",$mail);
            $st1->execute();
            $count=$st1->rowCount();
            //echo $count;
            $_SESSION['cart']= $count;
...
<html>
	...
	<body onResize="resetall()">
        ...
        <div id="mySidenav" class="sidenav">
                ...
                <a href="sellersignin.php">Seller</a>
        ...
        <!---------------------------------------------------- End of Menu--------------------------------------------->
        <div id="name">
				<a href="home.php" style="text-decoration:none;"><h1 style="white-space: nowrap; cursor:pointer;"><span class="highlight">e</span><a style="text-decoration:none; cursor:pointer;">-bOOKs</a></h1></a>
			...
			<nav class="upperbar">    
				<ul>
                    <li class="current"><a href="home.php" style="cursor: pointer; text-decoration:none;">Home</a></li>
                    <li><a href="about.html" style="text-decoration: none; color: white;">About</a></li>
                    <li><a href="signin.php" style="text-decoration: none; color: white;"><?php
                    echo  $ft['fname'];
                 ?></a></li>
                </ul>
		</nav>
		...
		<div class="cart">
                        <a href="cart.php"><img src="./image/cart.png" class="cart_image" style="width:40px; height:40px; margin-bottom:-70px; margin-left:-20px"></a>
